...
def run():
    ...
    print('HTTP server is started at http://{address}:{port}'.format(address=ADDRESS, port=PORT))
    print("Try: http://localhost:8080/conversion?buy_currency=GBP&sell_currency=USD&fixed_side=buy&amount=1000&reason=mortage&term_agreement=true")
